...
export default function FavoritesPage() {
  ...
  const loadFavorites = async () => {
    ...
    try {
      const items = watchProgress.getFavoritesItems();
      if (items.length === 0) {
        setFavorites([]);
        setLoading(false);
        return;
      ...
      setFavorites(details.filter(Boolean) as FavoriteItem[]);
    } catch (error) {
      logger.error('Failed to load favorites:', error);
      setFavorites([]);
    } finally {
  ...
  const handleRemove = async (item: MediaItem) => {
    ...
    watchProgress.removeFromFavorites(item.id);
      ...
      <div className="min-h-screen bg-[#050505] pt-32" style={{
        ...
        <div className="px-16 pb-16">
          ...
          <div className="mb-12">
            ...
            <h1 className="text-5xl font-black uppercase mb-4 text-white">Favourites</h1>
          ...
          {loading ? (
            ...
            <div className="text-center py-24">
              ...
              <p className="font-mono text-xs text-[#888] uppercase tracking-[2px] mb-8">CONNECT YOUR ACCOUNT TO SYNC FAVOURITES — OR ADD TITLES FROM DETAILS</p>
              <button
            ...
            <div className="text-center py-24">
              <h2 className="text-3xl font-black uppercase mb-4 text-white">NO FAVOURITES</h2>
              <p className="font-mono text-xs text-[#888] uppercase tracking-[2px] mb-8">NO ITEMS IN FAVOURITES</p>
              <button
                onClick={() => router.push('/')}
                className="bg-white hover:bg-white/90 text-black px-8 py-4 font-mono text-xs uppercase tracking-[2px] transition-all border border-white"
              >
        ...
        <div className="p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24">
              ...
              <h2 className="text-3xl font-bold text-netflix-light mb-3">Sign in to sync favorites</h2>
